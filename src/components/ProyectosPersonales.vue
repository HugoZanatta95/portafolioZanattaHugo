<script setup>
import proyecto1 from '/src/assets/CapturaProyecto.png';
import githubLink from '/src/components/icons/github_icon.svg';
import { ref } from 'vue';
...
/* .galeria{
    ...
    background-image: url("/src/assets/social-2deb6d7d43e7.jpg");
