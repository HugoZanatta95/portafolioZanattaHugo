...
const title = "Hugo J. Zanatta";
const descripcion = "Profesor de Tecnologías";
    ...
    <div class="card">
      ...
      <ul class="container-lista">
        <li v-for="red in redesSociales" :key="red.id">
          <a :href="red.url" target="_blank" class="social-link">
...
/* ...Quitar recuadro de las redes sociales INICIO... */
.social-link {
  border: none;
